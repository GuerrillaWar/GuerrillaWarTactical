class GWT_Effect_Suppression extends X2Effect_Suppression config(GWT_Stats_Effects);
...
function int GetAimModifierFromAbility(XComGameState_Ability SourceAbility, XComGameState_Unit SuppressedUnit)
{
	...
	{
		`log("Soldier SuppressionModfier" @ default.Multiplayer_AimPenalty);
		return default.Soldier_AimPenalty;
	}
	else
	{
		`log("Alien SuppressionModfier" @ default.Multiplayer_AimPenalty);
