...
var config int UTILITY_MOBILITY_BONUS;
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(AddUtilityBonusAbility());
...
static function X2AbilityTemplate AddUtilityBonusAbility()
{
	local X2AbilityTemplate					Template;
	local X2Effect_PersistentStatChange		PersistentStatChangeEffect;
	`CREATE_X2ABILITY_TEMPLATE(Template, 'UTILITY_STATS');
	...
	PersistentStatChangeEffect.BuildPersistentEffect(1, true, false, false);
	PersistentStatChangeEffect.SetDisplayInfo(ePerkBuff_Passive, "", "", Template.IconImage, false,,Template.AbilitySourceName);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_Mobility, default.UTILITY_MOBILITY_BONUS);
	Template.AddTargetEffect(PersistentStatChangeEffect);
